...
@Provider
@ApplicationScoped
@Consumes({"application/vnd.de.openknowledge.sample.address.v1+json", "application/json"})
public class AddressMessageBodyReader implements MessageBodyReader<Address> {
    ...
    public Address readFrom(Class<Address> targetClass, Type type, Annotation[] annotations, MediaType mediaType,
        ...
        MessageBodyReader<AddressV1> jsonReader = providers.getMessageBodyReader(AddressV1.class, AddressV1.class, annotations, APPLICATION_JSON_TYPE);
        AddressV1 address = jsonReader.readFrom(AddressV1.class, AddressV1.class, annotations, APPLICATION_JSON_TYPE, headers, in);
